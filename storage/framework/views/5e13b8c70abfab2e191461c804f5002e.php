    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('admin.branch.report')); ?>">
...
</html><?php /**PATH E:\4th yr 1st sem\mednest\resources\views/admin/branch-report.blade.php ENDPATH**/ ?>