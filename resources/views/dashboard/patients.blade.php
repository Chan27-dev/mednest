...
@section('title', 'Patient Records - MedNest')
                ...
                <table class="table mb-0">
                    ...
                    <tbody id="patientsTableBody">
                        ...
                        <tr data-patient-id="{{ $patient['id'] }}">
                            ...
                            <td>
                                <span class="status-badge status-{{ strtolower(str_replace(' ', '-', $patient['status'])) }}">
                                    {{ $patient['status'] }}
                                </span>
                            </td>
                            <td>
                                <div class="action-buttons">
                                    @foreach($patient['actions'] as $action)
                                        <button class="action-btn btn-{{ strtolower($action) }}" data-action="{{ strtolower($action) }}" data-patient="{{ $patient['name'] }}">
                                            {{ $action }}
                                        </button>
                                    @endforeach
                                </div>
