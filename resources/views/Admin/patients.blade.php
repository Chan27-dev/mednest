...
<body>
        ...
        <div class="page-content">
            ...
            <div class="content">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-number blue" id="totalPatients">{{ $patientsData['total_stats']['total_patients'] }}</div>
                        <div class="stat-label">Total Patients (All Branches)</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number orange" id="totalAppointments">{{ $patientsData['total_stats']['total_appointments'] }}</div>
                        <div class="stat-label">New Appointments</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number pink" id="totalLaborCases">{{ $patientsData['total_stats']['total_labor_cases'] }}</div>
                        <div class="stat-label">Total High-Risk Cases</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number green" id="monthlyRevenue">₱{{ number_format($patientsData['total_stats']['monthly_revenue']) }}</div>
                ...
                <div class="patients-table-container">
                    <div class="patients-table">
                        <table class="table mb-0">
                            ...
                            <tbody id="patientsTableBody">
                                @foreach($patientsData['patients'] as $patient)
                                <tr data-patient-id="{{ $patient['id'] }}">
                                    ...
                                    <td>
                                        <span class="branch-badge branch-{{ $patient['branch'] }}">
                                            @switch($patient['branch'])
                                                @case('daraga') Daraga @break
                                                @case('stodomingo') Sto. Domingo @break  
                                                @case('arimbay') Arimbay @break
                                                @default {{ ucfirst($patient['branch']) }}
                                            @endswitch
                                        </span>
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($patient['lastVisit'])->format('M j, Y') }}</td>
                                    <td>
                                        <span class="status-badge status-{{ $patient['status'] }}">{{ ucfirst($patient['status']) }}</span>
                                    </td>
                                    <td>
                                        @switch($patient['insurance'])
                                            @case('none') None @break
                                            @case('philhealth') PhilHealth @break
                                            @case('private') Private @break
                                            @default {{ ucfirst($patient['insurance']) }}
                                        @endswitch
                                    </td>
                                    <td>
                    ...
                    <div class="pagination-container">
                        <div class="pagination-info">
                            Showing 1 to {{ count($patientsData['patients']) }} of {{ $patientsData['total_stats']['total_patients'] }} patients
                        </div>
    ...
    <script>
        ...
        const initialPatientsData = @json($patientsData['patients']);
